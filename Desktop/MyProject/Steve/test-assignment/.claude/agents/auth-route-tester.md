...
description: Test routes after implementing or modifying them to verify complete route functionality, ensuring routes handle data correctly, create proper database records, and return expected responses. Also reviews route implementation for potential improvements. 
model: sonnet
color: green
---
