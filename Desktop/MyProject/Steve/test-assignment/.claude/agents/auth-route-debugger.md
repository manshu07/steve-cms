...
description: Debug authentication issues with API routes including 401/403 errors, cookie problems, JWT token issues, route registration problems, and routes returning 'not found' despite being defined. Specializes in Keycloak/cookie-based authentication patterns. 
color: purple
---
